...
def generate_launch_description() -> LaunchDescription:
    """
    Nav2 bringup WITHOUT planner_server.

    Uses Nav2's slam_launch, and a local `nav2_navigation_no_planner.launch.py`.
    """

    bringup_dir = get_package_share_directory("nav2_bringup")
    launch_dir = os.path.join(bringup_dir, "launch")
    local_launch_dir = os.path.dirname(__file__)
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(local_launch_dir, "nav2_navigation_no_planner.launch.py")),
                launch_arguments={
                    "namespace": namespace,
                    "use_sim_time": use_sim_time,
                    "autostart": autostart,
